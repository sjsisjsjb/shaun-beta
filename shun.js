...
"buttonParamsJson": JSON.stringify(listMessage) 
 ...
 {
 "name": "cta_url",
 "buttonParamsJson": "{\"display_text\":\"Creator\",\"url\":\"https://wa.me/6281378300839\",\"merchant_url\":\"https://wa.me/6281378300839\"}"
 },
 ],
 })
 })
...
case "bcimg": {
if (!isCreator) return reply(`Lu Hardi Kah?`)
...
case "listgc":{
if (!isCreator) return (`Ngapain ? Khusus Hardi Offcial Aja !!`)
let getGroups = await hardi.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let hituet = 0
